...
public class ExcelUtil {
	...
	public static <T> void createXlsx(List<T> pojoObjectList, String filePath, String fileName) throws IllegalAccessException, 
		...
		FileOutputStream fos = new FileOutputStream(filePath + pojoObjectList.get(0).getClass().getSimpleName().toUpperCase() + 
				"_" + fileName + "_" +System.currentTimeMillis() + ".xlsx");
		//String fileNameTemp = fileName + "_" + System.currentTimeMillis() + ".xlsx";
//		FileOutputStream fos = new FileOutputStream(filePath + fileName);
	...
	public static <T> void generateXlsx(List<T> pojoObjectList, String templateFileName, String sheetName, 
			String outputFilePath, String outputFileName) throws InvalidFormatException, IOException, 
	...
	private static Row RowFilledWithPojoHeader(Object pojoObject, Row row) throws IllegalAccessException, 
		IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
	...
	private static Row RowFilledWithPojoData(Object pojoObject, Row row) throws IllegalAccessException, 
		IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		...
		for(int i=0; i<fieldLength; i++) {
			Method method = pojoObject.getClass().getMethod("get" + fields[i].getName().substring(0, 1).toUpperCase() + 
