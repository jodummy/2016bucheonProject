...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/bucheon/resources/css/qlikSense.css">
  ...
  <body>
  	...
  	<nav class="navbar navbar-default">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="/bucheon/admin/wordcloud">워드클라우드</a></li>
    ...
    <div class="clearfix"></div>
  	...
  	<div class="col-sm-12">
  	<iframe src='https://121.141.38.85/single/?appid=aeff3982-0312-4b62-ba94-2fc8d5235fad&sheet=GzvjGM&lang=ko-KR&opt=currsel' style='border:none;'></iframe>
  	</div>
