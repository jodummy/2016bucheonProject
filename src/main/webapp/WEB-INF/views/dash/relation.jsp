...
<html lang="en">
  ...
  <body>
  	...
  	<nav class="navbar navbar-default">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="/bucheon/admin/relation">연관관계</a></li>
    ...
    <div class="clearfix"></div>
  	...
  	<iframe src='https://121.141.38.85/single/?appid=aeff3982-0312-4b62-ba94-2fc8d5235fad&sheet=PFRjC&lang=ko-KR&opt=currsel&select=clearall' style='border:none;'></iframe>
